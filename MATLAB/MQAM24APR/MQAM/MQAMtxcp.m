...
n_sym=8;
Ts=n_sym/fs;
ts_length=100; %in number of symbols
gb_length=200; %in number of symbols
...
save('MQAM.mat','Nb','levels','f1','data','span','ts_length','gb_length','A','n_sym','mod_signal','rrcFilter','continuous');
