...
levels = 2;
gb_length=50; %in number of symbols
ts_length=200; %in number of symbols
Nb=7004; %Number of bits to transmit
A=1; %amplitude to control distance between points in const.
...
save('MQAM.mat','Nb','levels','f1','data','n_bit','v','ts_length','gb_length','A');
