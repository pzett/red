...
levels = 3;
Nb=20004; %Number of bits to transmit
f1=fs/4;
%f1=10000;
n_sym=8;
Ts=n_sym/fs;
ts_length=504; %in number of symbols
...
save('MQAM.mat','Nb','levels','f1','data','span','ts_length','gb_length','A','n_sym','mod_signal','rrcFilter','qamrc');
