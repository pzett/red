function [gb,gb_end,ts,data_sent,data_encoded,Nb,data_scrambled] = generate_data(gb_length,gb_end_length,ts_length,Nb,levels,Nc,file,code,rate,iv)
...
if(iv)
    data_scrambled = scramble(data_sent);
end
