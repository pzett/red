...
P = 20; %length of prefix
S = 2; %length of suffix
Nc =256; %number of active subcarriers

pilot = 1; % use pilots in the middle of transmission?

pilot_int = 15*Nc*2*levels; %(in bits) how many bits should be sent before pilot insertion
...
gb_length=2*Nc; %(in symbols) length of guard band

Nb=60*FS;        %Number of bits to be transmitted
