...
ts_length=14*Nc; % (in symbols) length of training sequence
...
[gb,gb_end,ts,data_sent,data_encoded,Nb] = generate_data(gb_length,gb_end_length,ts_length,Nb,levels,Nc,file,code,rate);
...
[ ts_mod ] = save_and_plot(FS,S,P,up_signal,mod_signal,fs,Nc,gb_length,ts_length,Nb);
save('MQAM.mat','Nb','levels','fc','data_sent','gb_length','A','mod_signal','P','S','Nc','FS','high','file','rate','code','data_encoded','asym');
