...
scatterplot(mconstdem(ts_length:a/(2*levels))),grid,xlabel('I'),ylabel('Q'),title('Received Constellation after Rotation and Offset Correction');
errors = sum(data(1:a)' ~= decoded(1:a)  )
BER1_includingTS = errors /a* 100
