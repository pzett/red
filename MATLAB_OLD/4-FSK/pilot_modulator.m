function [mod_pilot,mod_tsequence] = pilot_modulator(tsequence,Nb,gb_length,Tb,fs,f1,f2,f3,f4,d_length)
...
window=gausswin(nr_samples_bit);%Window to be used to modulate tsequence
...
mod_pilot = mod_pilot/(max(abs(mod_pilot)+0.01));%normalize for wav playin'
