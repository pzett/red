function [ decoder_output] = convdecode( data_input,code_rate )
...
depth_of_trellis=length(data_input)/n;
channel_output_matrix=reshape(data_input,n,depth_of_trellis);
