...
P = 10; %length of prefix
S = 10; %length of suffix
...
[gb,gb_end,ts,data_sent,data_encoded,Nb,data_scrambled] = generate_data(gb_length,gb_end_length,ts_length,Nb,levels,Nc,file,code,rate,intlv);
...
elseif(intlv)
    bit_stream = [gb' ts' data_scrambled' gb_end']; % merge the data
else
