...
{
	public NTPUDPClient(long startMillis, long startNanos) {
		super();
    ...
    public TimeInfo getTime(InetAddress host, int port) throws IOException
    {
         ...
         */
        TimeStamp now = TimeStamp.getCurrentTime(startMillis, startNanos);
        ...
        TimeStamp returnTime = TimeStamp.getCurrentTime(startMillis, startNanos);
