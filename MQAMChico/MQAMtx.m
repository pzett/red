...
levels = 2;
gb_length=20; %in number of symbols
ts_length=50; %in number of symbols
...
ts_mod=ts_mod/(max(abs(ts_mod)+0.00001));
...
save('MQAM.mat','Nb','levels','f1','data','n_bit','v','ts_length','gb_length');
