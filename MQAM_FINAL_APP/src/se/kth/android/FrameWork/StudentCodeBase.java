...
public class StudentCodeBase implements OnPlaybackPositionUpdateListener  {
	...
	public String userInputStringMessage="Input a message and it will be stored as a text file on the phone to be sent.";
...
{ 
    ...
    {
        String fileName = new 
        String(Environment.getExternalStorageDirectory() + "/" + name);//+"data"+"/"+name);
        stream = null;
        try {
