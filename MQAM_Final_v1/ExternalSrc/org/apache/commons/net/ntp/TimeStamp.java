...
public class TimeStamp implements java.io.Serializable, Comparable<TimeStamp>
{
    ...
    */
     ...
     */
    public void OLDTimeStamp(Date d)
    {
        //ntpTime = (d == null) ? 0 : OLDtoNtpTime(d.getTime());
    }
    ...
    {
    	long now_nanos = getFraction()*1000000000L/0x100000000L;
    	return getSeconds()*1000000000L+now_nanos;
    }
    
    public static long fromNtpToNanos(long ntpTime)
    {
    	TimeStamp t = new TimeStamp(ntpTime);
    	return t.getNanoTime();
    }
    /***
     ...
     */
    public long OLDgetTime()
    {
        return OLDgetTime(ntpTime);
    }
     ...
     */
    public Date OLDgetDate()
    {
        long time = OLDgetTime(ntpTime);
     ...
     */
    public static long OLDgetTime(long ntpTimeValue)
    {
     ...
     */
    public static TimeStamp OLDgetNtpTime(long date)
    {
        return new TimeStamp(OLDtoNtpTime(date));
    }
     ...
     */
    public static TimeStamp getCurrentTime(long startMillis, long startNanos)
    {
    	long nanos = System.nanoTime();
        return new TimeStamp(toNtpTime(nanos,startMillis, startNanos)); 
    }
     ...
     */
    protected static long OLDtoNtpTime(long t)
    {
    ...
    protected static long toNtpTime(long cn, long st, long sn)
    {
    	long t = st+(cn-sn)/1000000; // Time in millis
        boolean useBase1 = t < msb0baseTime;    // time < Feb-2036
        long baseTime;
        if (useBase1) {
            baseTime = t - msb1baseTime; // dates <= Feb-2036
        ...
        //long fraction = ((baseTime%1000)*1000000+((cn-sn)%1000000))*1000;
        //long f0 = (cn-sn)%1000000;
        //long f1 = ((baseTime%1000)*1000000+f0);
        //long f2 = f1<<32;
        //long f3 = f2/1000000000;

		long fraction = (((baseTime%1000)*1000000+((cn-sn)%1000000))*0x100000000L)/1000000000 ;
